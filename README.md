...
- [Grupo 4 Report](#grupo-4-report)
- [DESARROLLO DE SOLUCIONES IOT](#desarrollo-de-soluciones-iot)
- [Registro de Versiones del Informe](#registro-de-versiones-del-informe)
  - [| 1.00 | 24/04/2025 | Todos los integrantes del equipo  | Se desarrolló la descripción del startup Chemtrack, presentando a los integrantes del equipo, la problemática a resolver y el análisis del mercado, incluyendo a la competencia y el valor agregado que ofrece nuestra solución dentro del nicho. Además, se definieron la visión y objetivos del proyecto, el segmento objetivo y se propuso una solución tecnológica basada en IoT para el monitoreo seguro del transporte de materiales peligrosos, sentando así las bases para el desarrollo futuro del sistema. Luego se implementó los demás artefactos necesarios para realizar una base sólida para la arquitectura, implementación, validación y desarrollo de ChemTrack.   |](#-100--24042025--todos-los-integrantes-del-equipo---se-desarrolló-la-descripción-del-startup-chemtrack-presentando-a-los-integrantes-del-equipo-la-problemática-a-resolver-y-el-análisis-del-mercado-incluyendo-a-la-competencia-y-el-valor-agregado-que-ofrece-nuestra-solución-dentro-del-nicho-además-se-definieron-la-visión-y-objetivos-del-proyecto-el-segmento-objetivo-y-se-propuso-una-solución-tecnológica-basada-en-iot-para-el-monitoreo-seguro-del-transporte-de-materiales-peligrosos-sentando-así-las-bases-para-el-desarrollo-futuro-del-sistema-luego-se-implementó-los-demás-artefactos-necesarios-para-realizar-una-base-sólida-para-la-arquitectura-implementación-validación-y-desarrollo-de-chemtrack---)
...
- [Capítulo V: Solution UX Design](#capítulo-v-solution-ux-design)
  ...
  - [5.2 Arquitectura de la Información](#52-arquitectura-de-la-información)
    - [5.2.1 Sistemas de Organización](#521-sistemas-de-organización)
    - [5.2.2 Sistemas de Etiquetado](#522-sistemas-de-etiquetado)
    - [5.2.3 Etiquetas SEO y Meta Tags](#523-etiquetas-seo-y-meta-tags)
    - [5.2.4 Sistemas de Búsqueda](#524-sistemas-de-búsqueda)
    - [5.2.5 Sistemas de Navegación](#525-sistemas-de-navegación)
  - [5.3. Landing Page UI Design](#53-landing-page-ui-design)
    - [5.3.1. Landing Page Wireframe](#531-landing-page-wireframe)
    - [5.3.2. Landing Page Mock-up](#532-landing-page-mock-up)
  - [5.4 Applications UI/UX Design](#54-applications-uiux-design)
  ...
  - [Capítulo VI: Product Implementation, Validation \& Deployment](#capítulo-vi-product-implementation-validation--deployment-1)
    - [Herramientas SaaS y de apoyo:](#herramientas-saas-y-de-apoyo)
    - [Desarrollo Embedded:](#desarrollo-embedded)
    - [Landing Page:](#landing-page)
    - [Herramientas de Comunicación:](#herramientas-de-comunicación)
    - [Recolección de Requisitos:](#recolección-de-requisitos)
    ...
    - [JavaScript (W3C JS Best Practices)](#javascript-w3c-js-best-practices)
    - [Gherkin (Gherkin Conventions for Readable Specifications)](#gherkin-gherkin-conventions-for-readable-specifications)
